...
public class UploadGaleria extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {			
        	...
        	boolean success = parametrosDTO.getPathLocalImagenesGaleria() != null && parametrosDTO.getPathLocalImagenesGaleria().length()>0?true:false;
	...
	public String procesaFicheros(HttpServletRequest req, ParametrosDTO parametrosDTO ) {
        try {
        	...
        	long maxBites = 1024*parametrosDTO.getMaxKBImagenesGaleria();
	                	...
	                	if(sizeFile<=maxBites) {
	                		...
	                		if(continuar) {	                		
		                		...
		                		if(parametrosDTO.getPathShell()!= null && parametrosDTO.getPathShell().length()>0) {
		                			if(parametrosDTO.getPathRemoteGallery() != null && parametrosDTO.getPathRemoteGallery().length()>0 && parametrosDTO.getAmbiente().equalsIgnoreCase("desarrollo")) {
	...
	public boolean transfiereWebServer(String local, ParametrosDTO parametrosDTO) {
		...
		String comando = parametrosDTO.getPathShell() + " " + local + "* " + parametrosDTO.getPathRemoteGallery();
